...
urlpatterns = [
    ...
    path('asistencia/escanear/', views.abrir_scanner, name='abrir_scanner'),
    path('asistencia/validar/<uuid:uuid_carnet>/', views.escanear_qr_alumno, name='escanear_qr_alumno'),
